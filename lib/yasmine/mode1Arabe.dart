...
import 'automatiqueButArabe.dart';
import 'ManuelButArabe.dart';
...
class Mode1Arabe extends StatelessWidget {
  const Mode1Arabe({Key? key}) : super(key: key);
  @override
