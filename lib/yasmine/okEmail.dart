...
class OkEmail extends StatelessWidget {
  const OkEmail({Key? key}) : super(key: key);
  @override
                    ...
                    Center(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            alignment: Alignment.center,
                            child: Text('Votre email a été \n bien envoyé', textAlign: TextAlign.center, style: TextStyle(fontSize: 20, color: Colors.black)),
                          ),
                        ],
                      ),
                    ),
